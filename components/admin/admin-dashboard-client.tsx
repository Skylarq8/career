...
export function AdminDashboardClient() {
  ...
  const latestBookings = useQuery(api.bookings.listBookings, {});

  if (!stats || !latestBookings) {
    return <AdminLoading label="Admin data уншиж байна..." />;
  }
  ...
  const cards = [
    ...
    { icon: FlaskConical, label: "RIASEC үр дүн", value: stats.testResults },
  ] as const;
    ...
    <>
      ...
      <div className="mt-8 rounded-[1.5rem] border border-line bg-soft-white p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <h2 className="heading-font text-2xl font-extrabold text-navy">Сүүлийн хүсэлтүүд</h2>
